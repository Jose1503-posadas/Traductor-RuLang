...
public interface RuVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link RuParser#declaracion_funcion}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDeclaracion_funcion(RuParser.Declaracion_funcionContext ctx);
	/**
	 * Visit a parse tree produced by {@link RuParser#lista_parametros}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLista_parametros(RuParser.Lista_parametrosContext ctx);
	/**
	 * Visit a parse tree produced by {@link RuParser#llamada_funcion}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLlamada_funcion(RuParser.Llamada_funcionContext ctx);
	/**
	 * Visit a parse tree produced by {@link RuParser#lista_argumentos}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLista_argumentos(RuParser.Lista_argumentosContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link RuParser#sentencia_for}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSentencia_for(RuParser.Sentencia_forContext ctx);
	/**
